                     ...
                     public void onSuccess(Uri uri) {
                        ...
                        databaseReference.child( databaseReference.push().getKey()).setValue(obj).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void unused) {
                                pd.dismiss();
                                Toast.makeText(admin_upload.this, "Successfully uploaded ", Toast.LENGTH_SHORT).show();
                                vtitle.setText("");
                            }
                            ...
                            public void onFailure(@NonNull Exception e) {
                                pd.dismiss();
                                Toast.makeText(admin_upload.this, "Failed to upload  : " +e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
